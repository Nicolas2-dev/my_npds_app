...
abstract class Adapter
{
     ...
     * [select description]
     *
     * @param   [type]  $statements  [$statements description]
     *
     * @return  [type]               [return description]
     */
    ...
    /**
     * [criteriaOnly description]
     *
     * @param   [type]$statements  [$statements description]
     * @param   [type]$bindValues  [$bindValues description]
    ...
    /**
     * [getUpdateStatement description]
     *
    ...
    /**
     * [arrayStr description]
     *
     * @param   array  $pieces         [$pieces description]
     * @param   [type] $glue           [$glue description]
     * @param   [type] $wrapSanitizer  [$wrapSanitizer description]
     * @param   true                   [ description]
     *
     * @return  [type]                 [return description]
     */
    ...
    /**
     * [buildCriteriaWithType description]
     *
     * @param   [type]$statements  [$statements description]
