...
function adm_translate($phrase) {
 ...
 switch($phrase) {
  ...
  case "- Mot de Passe (si Privé) - Le nom du fichier de formulaire (si Texte étendu) => library/sform/forum - Les Groupes ID (si Groupe)": $tmp="密码 (如果是私人的) 表格的文件名 => library/sform/forum - 组的ID (如果是已经存在的组)"; break;
