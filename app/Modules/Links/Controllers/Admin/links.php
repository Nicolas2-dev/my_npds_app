...
function LinksAddLink($new, $lid, $title, $url, $cat, $description, $name, $email, $submitter, $topicL)
{
    ...
    if ($new == 1) {
        ...
        if ($email != '') {
            ...
            $subject = html_entity_decode(translate("Votre lien"), ENT_COMPAT | ENT_HTML401, cur_charset) . " : ".Config::get('npds.sitename');
            $message = translate("Bonjour") . " $name :\n\n" . translate("Nous avons approuvé votre contribution à notre moteur de recherche.") . "\n\n" . translate("Titre de la page : ") . "$title\n" . translate("Url de la page : ") . "<a href=\"$url\">$url</a>\n" . translate("Description : ") . "$description\n" . translate("Vous pouvez utiliser notre moteur de recherche sur : ") . " <a href=\"Config::get('npds.nuke_url')/modules.php?ModPath=links&ModStart=links\">Config::get('npds.nuke_url')/modules.php?ModPath=links&ModStart=links</a>\n\n" . translate("Merci pour votre contribution") . "\n";
