...
function links()
{
    global $ModPath, $ModStart, $links_DB, $admin, $hlpfile;
...
function LinksAddLink($new, $lid, $title, $url, $cat, $description, $name, $email, $submitter, $topicL)
{
    ...
    if ($title == '') {
        ...
        echo '
        <div class="alert alert-danger">' . __d('links', 'Erreur : vous devez saisir un titre pour votre lien') . '</div>
    ...
    if (($url == '') and ($links_url == 1)) {
        ...
        echo "<br /><span class=\"rouge\">" . __d('links', 'Erreur : vous devez saisir une url pour votre lien') . "</span><br /><br />";
        echo "[ <a href=\"modules.php?ModStart=$ModStart&amp;ModPath=$ModPath\" class=\"noir\">" . __d('links', 'Retour en arrière') . "</a> ]<br />";
    ...
    if ($description == '') {
        ...
        echo '
        <div class="alert alert-danger">' . __d('links', 'Erreur : vous devez saisir une description pour votre lien') . '</div>
        <a href="modules.php?ModStart=' . $ModStart . '&amp;ModPath=' . $ModPath . '" class="btn btn-secondary">' . __d('links', 'Retour en arrière') . '</a>';
    ...
    echo '
    <div class="alert alert-success">' . __d('links', 'Nouveau lien ajouté dans la base de données') . '</div>
    <a href="modules.php?ModStart=' . $ModStart . '&amp;ModPath=' . $ModPath . '" class="btn btn-secondary">' . __d('links', 'Retour en arrière') . '</a>';
