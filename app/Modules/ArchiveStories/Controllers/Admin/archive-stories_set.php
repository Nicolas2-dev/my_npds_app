...
$hlpfile = '/language/manuels/' . Config::get('npds.language') . '/mod-archive-stories.html';

function ConfigureArchive($ModPath, $ModStart, $f_meta_nom, $f_titre)
{
    global $hlpfile;
...
switch ($subop) {
    ...
    default:
        ...
        ConfigureArchive($ModPath, $ModStart, $f_meta_nom, $f_titre);
    break;
}
