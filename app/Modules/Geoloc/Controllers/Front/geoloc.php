...
include_once('modules/' . $ModPath . '/lang/geoloc.lang-' . Config::get('npds.language') . '.php');
...
$affi .= '
      ...
      <ul class="nav nav-tabs mt-4">
         ...
         <li class="nav-item"><a id="aide-tab" class="nav-link" href="modules/geoloc/doc/aide_geo-' . Config::get('npds.language') . '.html" data-bs-target="#aide" data-bs-toggle="tab_ajax"><span class="d-sm-none"><i class=" fa fa-globe fa-lg me-2"></i><i class=" fa fa-question fa-lg"></i></span><span class="d-none d-sm-inline">' . geoloc_translate("Aide") . '</span></a></li>';
