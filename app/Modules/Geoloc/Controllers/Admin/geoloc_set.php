...
include('modules/' . $ModPath . '/lang/geoloc.lang-' . Config::get('npds.language') . '.php');

$f_titre = __d('geoloc', 'Configuration du module Geoloc');
...
function vidip()
{
    ...
    $sql = "DELETE FROM ip_loc WHERE ip_id >=1";

    if ($result = sql_query($sql))
        sql_query("ALTER TABLE ip_loc AUTO_INCREMENT = 0;");
}
