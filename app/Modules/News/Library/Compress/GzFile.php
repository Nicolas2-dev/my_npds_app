...
namespace App\Modules\News\Library\Compress;


use App\Modules\News\Library\Archive;
use App\Modules\News\Contracts\GzFileInterface;


class GzFile extends Archive implements GzFileInterface
{
