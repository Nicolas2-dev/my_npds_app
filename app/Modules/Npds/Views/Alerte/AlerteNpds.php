    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="bl_versusModalLabel"><img class="adm_img me-2" src="<?= site_url('assets/images/admin/message_npds.png'); ?>" alt="icon_" loading="lazy" /><?= __d('npds', 'Version'); ?> Npds^</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Vous utilisez Npds^ <?= $Version_Sub; ?> <?= $Version_Num; ?></p>
                <p><?= __d('npds', 'Une nouvelle version de Npds^ est disponible !'); ?></p>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="mt-3" id="bl_messageModalForm" action="" method="POST">
                    ...
                    <button type="submit" class="btn btn btn-primary btn-sm"><?= __d('npds', 'Confirmer la lecture') ; ?></button>
                </form>
            </div>
            <div class="modal-footer">
