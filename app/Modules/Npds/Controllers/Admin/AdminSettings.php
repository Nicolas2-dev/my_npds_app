...
/**
    ...
    function Configure()
    {
        ...
        echo '
                ...
                <div class="mb-3 row">
                    <label class="col-form-label col-sm-4" for="xApp_twi">' . adm_translate("Activer Twitter") . '</label>
                    <div class="col-sm-8 my-2">';
        ...
        echo '
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="xApp_twi_y">' . adm_translate("Oui") . '</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" id="xApp_twi_n" name="xApp_twi" value="0" ' . $ckn . ' />
                        <label class="form-check-label" for="xApp_twi_n">' . adm_translate("Non") . '</label>
                    </div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label class="col-form-label col-sm-4" for="xApp_fcb">' . adm_translate("Activer Facebook") . '</label>
                    <div class="col-sm-8 my-2">';
        ...
        echo '
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="xApp_fcb_y">' . adm_translate("Oui") . '</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" id="xApp_fcb_n" name="xApp_fcb" value="0" ' . $ckn . ' />
                        <label class="form-check-label" for="xApp_fcb_n">' . adm_translate("Non") . '</label>
                    </div>
                    </div>
                </div>
            </div>
        ...
        echo '
                ...
                <div class="mb-3 row">
                    ...
                    <select class="form-select" id="xdownload_cat" name="xdownload_cat">
                        <option value="' . Config::get('npds.download_cat') . '">' . aff_langue($dowConfig::get('npds.download_cat')nload_cat) . '</option>';
