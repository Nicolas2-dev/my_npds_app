...
/**
    ...
    // {
        ...
        // $hlpfile = "language/manuels/Config::get('npds.language')/overload.html";
    ...
    function save_supercache($xsupercache, $xt_index, $xt_article, $xt_sections, $xt_faq, $xt_links, $xt_forum, $xt_memberlist, $xt_modules)
    {
        ...
        $content = "<?php\n";
        $content .= "$line";
        $content .= "/* DUNE by App / SUPER-CACHE engine                                    */\n";
        $content .= "/*                                                                      */\n";
        $content .= "/* App Copyright (c) 2002-2019 by Philippe Brunier                     */\n";
        $content .= "/*                                                                      */\n";
