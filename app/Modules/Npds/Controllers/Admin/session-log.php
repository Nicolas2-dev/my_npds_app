...
if ($subop == 'mailog') {
    ...
    $subject = html_entity_decode(SessionLog_translate("Fichier de Log de"), ENT_COMPAT | ENT_HTML401, cur_charset) . ' ' . Config::get('npds.sitename');
    $message = SessionLog_translate("Fichier de Log de") . ' ' . Config::get('npds.sitename') . "<br /><br />";
