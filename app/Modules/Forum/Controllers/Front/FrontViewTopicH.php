...
class FrontViewTopicH extends FrontController
{
    ...
    public function index()
    {
        ...
        function makebranch($parcat, $table, $level, $maxlevel, $max_post_id, $clas, $idtog)
        {
            ...
            global $theme, $forum, $forum_type, $allow_bbcode, $allow_to_post, $forum_access, $Mmod, $topic, $lock_state, $userdata;
            global $allow_upload_forum, $att, $last_read, $toggle;
            ...
            foreach ($list as $key => $val) {
                ...
                if ($forum_access != 9) {
                    ...
                    if (($Mmod) or (!empty($userdata[0])) and ($posterdata['uid'] == $userdata[0]) and (!$lock_state) and ($posterdata['uid'] != '')) {
                        echo '<a class="me-3" href="editpost.php?post_id=' . $myrow["post_id"] . '&amp;topic=' . $topic . '&amp;forum=' . $forum . '&amp;arbre=1" title="' . __d('forum', 'Editer') . '" data-bs-toggle="tooltip"><i class="fa fa-edit fa-lg"></i></a>';
                    ...
                    if ($allow_to_post and !$lock_state and $posterdata['uid'] != '')
                        echo '<a class="me-3" href="replyH.php?topic=' . $topic . '&amp;forum=' . $forum . '&amp;post=' . $myrow['post_id'] . '&amp;citation=1" title="' . __d('forum', 'Citation') . '" data-bs-toggle="tooltip"><i class="fa fa-quote-left fa-lg"></i></a>';
                    ...
                    if ($Mmod) {
                        ...
                        if (!$myrow['post_aff'])
                            echo '&nbsp;<a href="topicadmin.php?mode=aff&amp;topic=' . $topic . '&amp;post=' . $myrow['post_id'] . '&amp;ordre=1&amp;forum=' . $forum . '&amp;arbre=1" title="' . __d('forum', 'Afficher ce post') . '" data-bs-toggle="tooltip"><i class="fa fa-eye text-danger fa-lg"></i></a>&nbsp;';
                        else
                            echo '&nbsp;<a href="topicadmin.php?mode=aff&amp;topic=' . $topic . '&amp;post=' . $myrow['post_id'] . '&amp;ordre=0&amp;forum=' . $forum . '&amp;arbre=1" title="' . __d('forum', 'Masquer ce post') . '" data-bs-toggle="tooltip"><i class="fa fa-eye-slash fa-lg "></i></a>&nbsp;';
                    }
                }
        ...
        function aff_pub($lock_state, $topic, $forum, $post, $bouton)
        {
            ...
            if ($lock_state == 0) {
                if (($bouton == 2) or ($bouton == 9))
                    $ibid = '<a class="" href="newtopic.php?forum=' . $forum . '" title="' . __d('forum', 'Nouveau sujet') . '" data-bs-toggle="tooltip" ><i class="fa fa-plus-square "></i></a>&nbsp;';
            } else
                $ibid = '<i class="fa fa-lock fa-lg text-danger" title="' . __d('forum', 'Ce sujet est verrouillé : il ne peut accueillir aucune nouvelle contribution.') . '" data-bs-toggle="tooltip"></i>&nbsp;';
        ...
        function aff_pub_in($lock_state, $topic, $forum, $post)
        {
            ...
            if ($lock_state == 0)
                $ibid = '<a class="me-3" href="replyH.php?topic=' . $topic . '&amp;forum=' . $forum . '&amp;post=' . $post . '" title="' . __d('forum', 'Répondre') . '" data-bs-toggle="tooltip"><span class="d-none d-md-inline"></span><i class="fa fa-reply me-2"></i><span class="d-none d-md-inline">' . __d('forum', 'Répondre') . '</span></a>';
        ...
        for ($i = 0; $i < $ibidcountmod; $i++) {
            ...
            echo '<a href="user.php?op=userinfo&amp;uname=' . $moderator[$i] . '"><img class=" img-thumbnail img-fluid n-ava-small me-1 mb-1" src="' . $imgtmp . '" alt="' . $modera['uname'] . '" title="' . __d('forum', 'Modéré par : ') . ' ' . $modera['uname'] . '" data-bs-toggle="tooltip" /></a>';
        }
        ...
        if (isset($start)) {
            ...
            $sql = "SELECT * FROM posts WHERE topic_id='$topic' AND forum_id='$forum'" . $post_aff . "ORDER BY post_id";
        } else {
            $sql = "SELECT * FROM posts WHERE topic_id='$topic' AND forum_id='$forum'" . $post_aff . "ORDER BY post_id";
        }
        ...
        if ($allow_upload_forum) {
            ...
            $sql2 = "SELECT att_id FROM $upload_table WHERE apli='forum_App' && topic_id = '$topic' $visible";
        ...
        if ((($Mmod) and ($forum_access != 9)) or (isset($adminforum))) {
            ...
            if ($lock_state == 0)
                echo '
                    <li class="nav-item">
                       <a class="nav-link" role="button" href="topicadmin.php?mode=lock&amp;topic=' . $topic . '&amp;forum=' . $forum . '&amp;arbre=1" ><i class="fa fa-lock fa-lg d-md-none" title="' . __d('forum', 'Fermer ce sujet') . '" data-bs-toggle="tooltip"></i><span class="ms-2 d-none d-md-inline">' . __d('forum', 'Fermer ce sujet') . '</span></a>
                    </li>';
            else
                echo '
                    <li class="nav-item">
                       <a class="nav-link" role="button" href="topicadmin.php?mode=unlock&amp;topic=' . $topic . '&amp;forum=' . $forum . '&amp;arbre=1" ><i class ="fa fa-unlock fa-lg d-md-none" title="' . __d('forum', 'Ouvrir ce sujet') . '" data-bs-toggle="tooltip"></i><span class="ms-2 d-none d-md-inline">' . __d('forum', 'Ouvrir ce sujet') . '</span></a>
                    </li>';
        
            echo '
                    <li class="nav-item">
                       <a class="nav-link" role="button" href="topicadmin.php?mode=move&amp;topic=' . $topic . '&amp;forum=' . $forum . '&amp;arbre=1"><i class="fa fa-share fa-lg d-md-none" title="' . __d('forum', 'Déplacer ce sujet') . '" data-bs-toggle="tooltip" ></i><span class="ms-2 d-none d-md-inline">' . __d('forum', 'Déplacer ce sujet') . '</span></a>
                    </li>
                    <li class="nav-item">
                       <a class="nav-link" role="button" href="topicadmin.php?mode=first&amp;topic=' . $topic . '&amp;forum=' . $forum . '&amp;arbre=1"><i class="fas fa-level-up-alt fa-lg d-md-none"  title="' . __d('forum', 'Mettre ce sujet en premier') . '" data-bs-toggle="tooltip"></i><span class="ms-2 d-none d-md-inline">' . __d('forum', 'Mettre ce sujet en premier') . '</span></a>
                    </li>
                    <li class="nav-item">
                       <a class="nav-link text-danger" role="button" href="topicadmin.php?mode=del&amp;topic=' . $topic . '&amp;forum=' . $forum . '&amp;arbre=1"><i class="fas fa-times fa-lg d-md-none"  title="' . __d('forum', 'Effacer ce sujet') . '" data-bs-toggle="tooltip"></i><span class="ms-2 d-none d-md-inline">' . __d('forum', 'Effacer ce sujet') . '</span></a>
                    </li>
                 </ul>';
        }
