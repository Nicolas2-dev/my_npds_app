...
$f_titre = __d('reseauxsociaux', 'Module') . ' : ' . $ModPath;
...
function ListReseaux($ModPath, $ModStart, $f_meta_nom, $f_titre)
{
    ...
    echo '
    <hr />
    <h3><a href="admin.php?op=Extend-Admin-SubModule&amp;ModPath=' . $ModPath . '&amp;ModStart=' . $ModStart . '&amp;subop=AddReseaux"><i class="fa fa-plus-square"></i></a>&nbsp;' . __d('reseauxsociaux', 'Ajouter') . '</h3>
    ...
    foreach ($rs as $v1) {
        echo '
            <tr>
                ...
                <td>
                <a href="admin.php?op=Extend-Admin-SubModule&amp;ModPath=' . $ModPath . '&amp;ModStart=' . $ModStart . '&amp;subop=EditReseaux&amp;rs_id=' . urlencode($v1[0]) . '&amp;rs_url=' . urlencode($v1[1]) . '&amp;rs_ico=' . urlencode($v1[2]) . '" ><i class="fa fa-edit fa-lg me-2 align-middle" title="' . __d('reseauxsociaux', 'Editer') . '" data-bs-toggle="tooltip" data-bs-placement="left"></i></a>
                <a href="admin.php?op=Extend-Admin-SubModule&amp;ModPath=' . $ModPath . '&amp;ModStart=' . $ModStart . '&amp;subop=DeleteReseaux&amp;rs_id=' . urlencode($v1[0]) . '&amp;rs_url=' . urlencode($v1[1]) . '&amp;rs_ico=' . urlencode($v1[2]) . '" ><i class="fas fa-trash fa-lg text-danger align-middle" title="' . __d('reseauxsociaux', 'Effacer') . '" data-bs-toggle="tooltip"></i></a>
                </td>
            </tr>';
    }
