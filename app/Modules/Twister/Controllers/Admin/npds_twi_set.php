...
/*                                                                      */
/* module App_twi version v.1.0                                        */
/* App-twi_set.php file 2015 by Jean Pierre Barbary (jpb)              */
/* dev team :                                                           */
/************************************************************************/
...
include('modules/' . $ModPath . '/lang/twi.lang-' . Config::get('npds.language') . '.php');
...
function Configuretwi($subop, $ModPath, $ModStart, $class_sty_2, $npds_twi_arti, $npds_twi_urshort, $npds_twi_post, $consumer_key, $consumer_secret, $oauth_token, $oauth_token_secret, $tbox_width, $tbox_height)
{
    ...
    $hlpfile = 'modules/' . $ModPath . '/doc/admtwi-' . Config::get('npds.language') . '.html';

    global $f_meta_nom, $f_titre, $npds_twi;
