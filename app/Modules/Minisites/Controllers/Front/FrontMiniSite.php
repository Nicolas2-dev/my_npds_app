...
class FrontMiniSite extends FrontController
{
    ...
    public function index()
    {
        ...
        $copyright = '<span class="blog_sname">' . Config::get('npds.sitename') . '</span>&nbsp;<span class="blog_App">App&nbsp;HUB-BLOG&nbsp;<a href="http://www.App.org">App</a></span>';
        ...
        if ($affich) {
            ...
            if (file_exists($fic)) {
                ...
                if (strstr($Xcontent, '!blog!')) {
                    ...
                    $content = readnews($dir, $op, $per_page, $startpage, $action, $adminblog);
