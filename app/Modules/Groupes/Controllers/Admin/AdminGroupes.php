...
namespace App\Modules\Groupes\Controllers\Admin;

use App\Modules\Npds\Core\AdminController;


class AdminGroupes extends AdminController
{
    ...
    // {
        // $f_meta_nom = 'groupes';
        // $f_titre = __d('groupes', 'Gestion des groupes');
        
        // //==> controle droit
        // admindroits($aid, $f_meta_nom);
        // //<== controle droit
        
        // $hlpfile = "language/manuels/Config::get('npds.language')/groupes.html";
        ...
        //             $row = sql_fetch_row(sql_query("SELECT MAX(groupe_id) FROM groupes"));
        ...
        //         if ($ok_grp) {
        //             sql_query("INSERT INTO groupes VALUES ('$groupe_id', '$groupe_name','$groupe_description','0','0','0','0','0')");
    ...
    {
        sql_query("UPDATE groupes SET groupe_pad = '1' WHERE groupe_id = '$groupe_id';");
    ...
    {
        sql_query("UPDATE groupes SET groupe_pad = '0' WHERE groupe_id = '$groupe_id';");
    ...
    {
        $sql = "CREATE TABLE IF NOT EXISTS blocnotes (
        ...
        sql_query("UPDATE groupes SET groupe_blocnote = '1' WHERE groupe_id = '$groupe_id';");
    ...
    {
        sql_query("UPDATE forums SET forum_moderator = '$forum_moderator' WHERE forum_id='$forum_id'");
    }
    ...
    {
        sql_query("UPDATE groupes SET groupe_chat = '1' WHERE groupe_id = '$groupe_id';");
    ...
    {
        sql_query("UPDATE groupes SET groupe_chat = '0' WHERE groupe_id = '$groupe_id';");
