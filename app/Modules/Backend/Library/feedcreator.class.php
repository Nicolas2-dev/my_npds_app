...
Mods for App SABLE: time, date, encoding and some other things
Mods for App REv 13: support for PHP 5.5.x and other things
Mods for App REv 16: support for PHP 7.x and other things
...
mysql_select_db(Config::get('npds.dbhost'), $dbUser, Config::get('npds.dbpass'));
 ...
 * Version string.
 **/
define("FEEDCREATOR_VERSION", "FeedCreator 2.0 for App");
...
class FeedCreator extends HtmlDescribable {
    ...
    */
   var $syndicationURL, $image, $copyright, $pubDate, $lastBuildDate, $editor, $editorEmail, $webmaster, $category, $docs, $ttl, $rating, $skipHours, $skipDays;
...
class FeedDate {
   ...
   function rfc822() {
      ...
      $date = gmdate("D, d M Y H:i:s", $this->unix+(3600*(integer) Config::get('npds.gmt')));
    ...
    */
   function iso8601() {
      $date = gmdate("Y-m-d\TH:i:sO",$this->unix+(3600*(integer) Config::get('npds.gmt')));
    ...
    */
   function unix() {
      return $this->unix+(3600*(integer) Config::get('npds.gmt'));
   }
}
