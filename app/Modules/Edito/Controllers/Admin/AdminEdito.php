...
namespace App\Modules\Edito\Controllers\Admin;


use App\Modules\Npds\Core\AdminController;


class AdminEdito extends AdminController
{
    ...
    // {
        ...
        // $hlpfile = "language/manuels/Config::get('npds.language')/edito.html";
