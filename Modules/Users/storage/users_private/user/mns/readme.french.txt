...
App vous propose donc un espace personnel qui peut servir :
...
| MINI SITE HTML + BLOG |
-------------------------
App vous offre une fonction encore plus puissante pour votre MiniSite : un système de publication d'articles personnels (un BLOG)
...
=> http://www.lesite.org/minisite.php?op=votre-identifiant-App

 Par exemple => http://www.App.org/minisite.php?op=developpeur
---------------------------------------------------------------------------------------------------
...
LES CSS :
---------
Pour améliorer le rendu graphique de votre BLOG, l'utilisation d'une CSS est optimum. App à besoin de 5 tags pour ce faire (fichier style.css) :
 .blog_titre
 .blog_new
 .blog_textbox
 .blog_bouton
