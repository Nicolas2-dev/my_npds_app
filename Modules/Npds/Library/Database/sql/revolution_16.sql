...
INSERT INTO authors (aid, name, url, email, pwd, hashkey, counter, radminsuper) VALUES ('Root', 'Root', '', 'root@App.org', 'd.8V.L9nSMMvE', 0, 0, 1);
...
INSERT INTO fonctions (fid, fnom, fdroits1, fdroits1_descr, finterface, fetat, fretour, fretour_h, fnom_affich, ficone, furlscript, fcategorie, fcategorie_nom, fordre) VALUES(36, 'mes_App_versus', 36, '', 1, 1, '', 'Une nouvelle version est disponible ! Cliquez pour acc&#xE9;der &#xE0; la zone de t&#xE9;l&#xE9;chargement de App.', '', 'message_App', '', 9, 'Alerte', 0);
...
INSERT INTO fonctions (fid, fnom, fdroits1, fdroits1_descr, finterface, fetat, fretour, fretour_h, fnom_affich, ficone, furlscript, fcategorie, fcategorie_nom, fordre) VALUES(49, 'App_twi', 49, '', 1, 1, '', '', 'App_Twitter', 'App_twi', 'href="admin.php?op=Extend-Admin-SubModule&ModPath=App_twi&ModStart=admin/App_twi_set"', 6, 'Modules', 0);
...
INSERT INTO headlines VALUES (1, 'App', 'http://www.App.org', 'http://www.App.org/backend.php', 0);
INSERT INTO headlines VALUES (2, 'Modules', 'http://modules.App.org', 'http://modules.App.org/backend.php', 0);
INSERT INTO headlines VALUES (3, 'Styles', 'http://styles.App.org', 'http://styles.App.org/backend.php', 0);
...
INSERT INTO lblocks VALUES (2, '[french]Menu[/french][english]Menu[/english][chinese]&#x83DC;&#x5355;[/chinese][spanish]Men&#xFA;[/spanish][german]Men&#xFC;[/german]', 'function#mainblock', '0', 1, 86400, 1, 0, 'Ce menu contient presque toutes les fonctions de base disponibles dans App');
...
INSERT INTO metalang (def, content, type_meta, type_uri, uri, description, obligatoire) VALUES('App', '<a href="http://www.App.org" target="_blank" title="www.App.org">App</a>', 'mot', '-', NULL, NULL, '1');
...
INSERT INTO metalang (def, content, type_meta, type_uri, uri, description, obligatoire) VALUES('!B_class_title!', '', 'them', '-', NULL, '[french]Sera remplac&eacute; par la class CSS du titre - voir le gestionnaire de bloc de App / actif dans bloc.html[/french]', '1');
INSERT INTO metalang (def, content, type_meta, type_uri, uri, description, obligatoire) VALUES('!B_class_content!', '', 'them', '-', NULL, '[french]Sera remplac&eacute; par la class CSS du contenu - voir le gestionnaire de bloc de App  / actif dans bloc.html[/french]', '1');
...
INSERT INTO poll_desc VALUES (2, 'App', 1004108978, 1);
...
INSERT INTO rblocks VALUES (2, 'Information', '<p align="center"><a href="http://www.App.org" target="_blank"><img src="assets/images/powered/miniban-bleu.png" border="0" alt="App_logo" /></a></p>', '0', 0, 0, 1, 0, '');
...
INSERT INTO topics VALUES (1, 'App', 'App.gif', 'App', 0, NULL);
...
INSERT INTO users VALUES (2, 'user', 'user', 'user@user.land', '', 'http://www.userland.com', '014.gif', '989445600', '', '', '', 'User of the Land', 0, 0, '', 'd.q1Wcp0KUqsk', 0, 10, '', 0, 0, 0, '', 1, '<ul><li><a href=http://www.App.org target=_blank>App.ORG</a></li></ul>', 'App-boost_sk+default', 4096, 4, 0, 1, 1, 'french', '1384102103', 1);
