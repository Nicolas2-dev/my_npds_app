                ...
                if ($ficpres_fma[1]) {
                    ...
                    switch ($suf) {
                        ...
                        case "mp3":
                            ...
                            $files .= "<div class=\"mp3\"><p align=\"center\">" . __d('fmanager', 'Cliquer ici pour charger le fichier dans le player') . "</p><br />" . split_string_without_space($obj->FieldName, 24) . "</div>";
