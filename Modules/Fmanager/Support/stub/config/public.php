...
return [
    ...
    // $App_fma permet d'inclure le files-manager dans le theme de App
    $App_fma = false;

    // $css_fma permet d'inclure la css d'un theme / Cette option n'a de sens que si $App_fma=false
