...
return [
     ...
     */
    'racine_fm' => dirname($_SERVER['SCRIPT_FILENAME']),
     ...
     */
    'basedir_fma' => function($groupe) {
        return Config::get('fmanager.admin.racine_fma') .'/storage/users_private/groupe/'. $groupe;
    },
     ...
     * celui-ci et contenant une variable (url_modifier)
    ...
    /**
     * permet d'inclure la css d'un thème
     * 
