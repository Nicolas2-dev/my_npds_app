...
echo '
        ...
        <script type="text/javascript" src="' . site_url('assets/shared/bootstrap-table/dist/locale/bootstrap-table-' . Language::language_iso(1, "-", 1) . '.min.js') . '" async="async"></script>
