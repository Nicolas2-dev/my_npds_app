...
<head>
    ...
    <link rel="stylesheet" href="<?php echo implode($result[1]); ?>assets/shared/prismjs/prism.css" />
...
<body>
    <nav class="<?php echo $headerclasses; ?>">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><img class="me-2" width="32" height="32" src="<?php echo implode($result[1]); ?>" assets/images/admin/message_App.png" alt="logo_App">App skins</a>
            ...
            <div class="page-header" id="banner">
                <div class="row d-flex align-items-center">
                    <div class="col-md-4 mb-3">
                        ...
                        <p class="lead">Nice skin for App Cms</p>
                        <img class="img-fluid" src="../../../../themes/App-boost_sk/images/header.png" alt="App" />
                    </div>
    ...
    <footer class="mt-5 px-2">
        <div class="row">
            <div class="col-sm-12">
                ...
                <p>App fork by <a href="#" rel="nofollow">Jpb</a>. Contact him at <a href="mailto:jpb@App.org">jpb@App.org</a>.</p>
    ...
    <script type="text/javascript" src="<?php echo implode($result[1]); ?>assets/shared/prismjs/prism.js"></script>
