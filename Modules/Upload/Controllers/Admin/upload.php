...
$f_titre = __d('upload', 'Configuration Upload');

//==> controle droit
admindroits($aid, $f_meta_nom);
//<== controle droit

$hlpfile = 'manuels/' . Config::get('npds.language') . '/upload.html';

include("modules/upload/lang/upload.lang-Config::get('npds.language').php");

function upConfigure($ModPath, $ModStart, $f_meta_nom, $f_titre)
{
...
switch ($subop) {
    ...
    default:
        ...
        upConfigure($ModPath, $ModStart, $f_meta_nom, $f_titre);
        break;
}
