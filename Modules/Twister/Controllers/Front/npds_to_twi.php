...
/*                                                                      */
/* module App_twi version 1.0                                          */
/* App_to_twi.php file 2015 by Jean Pierre Barbary jpb                 */
/************************************************************************/
...
if (Config::get('npds.npds_twi') === 1) {
    ...
    require_once('modules/App_twi/include/ab-twitteroauth/twitteroauth/twitteroauth.php');
    require_once('modules/App_twi/twi_conf.php');
