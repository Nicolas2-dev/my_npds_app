...
App thus offers a personal space that can be used to:
...
| MINI SITE HTML + BLOG |
-------------------------
App offers an even more powerful feature for your Minisite: publication of personal news (a blog)
...
=> Http://www.lesite.org/minisite.php?op=votre-identifiant-App
  ...
  For example => http://www.App.org/minisite.php?op=developpeur
---------------------------------------------------------------------------------------------------
...
CSS :
---------
To improve the graphical rendering of your blog, the use of CSS is optimum. App need only 5 tags to do so (style.css):
 .blog_titre
 .blog_new
 .blog_textbox
 .blog_bouton
