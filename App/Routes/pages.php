...
/* ===========================                                          */
/*                                                                      */
/* App Copyright (c) 2002-2019 by Philippe Brunier                     */
/*                                                                      */
...
//   => Permet de charger une ou plusieurs css spécifiques (aussi bien local que distant) en complément ou en remplacement de la CSS du theme de App
//
...
//
//   => Le JS LOCAL DOIT IMPERATIVEMENT se trouver dans le répertoire js de votre thème (theme/votre_theme/js) OU LE CHEMIN doit-être explicite depuis la racine du site("yui/build/...")
...
// Attention cette faculté n'est pas aussi parfaite que l'intégration de la gestion des droits de App mais rend bien des services
// ---------------
...
$PAGES['user.php']['css'] = array(Config::get('npds.nuke_url') . "assets/shared/ol/ol.css+");
...
$PAGES['admin.php']['css'] = array("admin.css+" . "assets/shared/ol/ol.css+");
...
$PAGES['modules.php?ModPath=App_galerie&ModStart=gal*']['title'] = "[french]Galerie d'images[/french][english]Pictures galery[/english][spanish]Galeria de imagenes[/spanish]+";
$PAGES['modules.php?ModPath=App_galerie&ModStart=gal*']['js'] = array(Config::get('npds.nuke_url') . '/modules/App_galerie/js/jquery.watermark.min.js');
$PAGES['modules.php?ModPath=App_galerie&ModStart=gal*']['run'] = "yes";
$PAGES['modules.php?ModPath=App_galerie&ModStart=gal*']['blocs'] = "0";
$PAGES['modules.php?ModPath=App_galerie&ModStart=gal*']['TinyMce'] = 1;
$PAGES['modules.php?ModPath=App_galerie&ModStart=gal*']['TinyMce-theme'] = "short";
$PAGES['modules.php?ModPath=App_galerie&ModStart=gal*']['css'] = array(Config::get('npds.nuke_url') . '/modules/App_galerie/css/galerie.css+');
...
$PAGES['modules.php?ModPath=geoloc&ModStart=geoloc*']['css'] = array(Config::get('npds.nuke_url') . '/assets/shared/ol/ol.css+' . '/modules/geoloc/include/css/geoloc_style.css+');
